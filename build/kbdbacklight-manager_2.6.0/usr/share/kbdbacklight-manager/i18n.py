...
translations = {
    "en": {
        ...
        "burn_duration": "Duration (Seconds)",
        "reset_app": "Reset Application",
        "set": "Set",
        "clear": "Clear",
        "save_apply": "Save and Apply",
        "increase_light": "Increase/Light:",
        "decrease_light": "Decrease:",
        "cancel_shortcut": "Cancel Shortcut Assignment",
        ...
        "stop": "Stop ⏹",
        "sos_mode": "SOS Mode 🆘",
        "about_text": "Universal keyboard backlight management tool for Linux laptops.\n\nVersion: 2.6.0\nDeveloper: Antigravity & Deepmind Team",
        "reset_q": "Do you want to completely reset the application and settings?",
        "reset_desc": "This will clear all shortcuts, settings, and uninstall packages. Password may be required.",
        "sc_success": "Shortcuts updated successfully.",
    ...
    "tr": {
        ...
        "burn_duration": "Yanma Süresi (Saniye)",
        "reset_app": "Uygulamayı Sıfırla",
        "set": "Ayarla",
        "clear": "Temizle",
        "save_apply": "Kaydet ve Uygula",
        "increase_light": "Artır/Yansın:",
        "decrease_light": "Azalt:",
        "cancel_shortcut": "Tuş Atamasını İptal Et",
        ...
        "stop": "Durdur ⏹",
        "sos_mode": "SOS Modu 🆘",
        "about_text": "Linux laptoplar için geliştirilmiş emrensel klavye ışığı yönetim aracı.\n\nSürüm: 2.6.0\nGeliştirici: Antigravity & Deepmind Team",
        "reset_q": "Uygulamayı ve ayarları tamamen sıfırlamak istiyor musunuz?",
        "reset_desc": "Bu işlem tüm kısayolları, ayarları ve paketleri temizler. Şifreniz istenebilir.",
        "sc_success": "Kısayollar başarıyla güncellendi.",
        ...
        "shortcut_mgr": "Kısayol Yöneticisi",
